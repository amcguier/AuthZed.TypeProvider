...
[<assembly: AssemblyTitleAttribute("AuthZed.TypeProvider.Tests")>]
[<assembly: AssemblyProductAttribute("AuthZed.TypeProvider")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "AuthZed.TypeProvider.Tests"
    let [<Literal>] AssemblyProduct = "AuthZed.TypeProvider"
